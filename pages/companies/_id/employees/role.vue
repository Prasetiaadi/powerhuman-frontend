        ...
        <form class="w-full card">
            ...
            <div class="form-group">
                ...
                <select v-else name="roles" :value="role_id" @change="updateRoleId"
                    ...
                    <option :value="role.id" :key="role.id" v-for="role in roles.data.result.data">
                        {{ role.name }}
                    </option>
                </select>
            </div>
            ...
            <section>
                ...
                <div class="flex flex-col gap-4 mt-[10px]">
                    <div class="flex items-start md:items-center gap-[6px]" :key="responsibility.id" v-for="responsibility in responsibilities">
